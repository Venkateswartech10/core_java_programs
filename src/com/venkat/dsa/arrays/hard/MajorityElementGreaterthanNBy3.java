...
public class MajorityElementGreaterthanNBy3 {
	...
	public static void main(String[] args) {
		...
		List<Integer> ans = majorityElementTwoBrute(arr);
        ...
        List<Integer> ans1 = majorityElementTwoBetter(arr);
        System.out.print("The majority elements are: ");
        for (int it : ans1) {
            System.out.print(it + " ");
        }
        ...
        List<Integer> ans2 = majorityElementTwoOptimal(arr);
        System.out.print("The majority elements are: ");
        for (int it : ans2) {
            System.out.print(it + " ");
        }
	...
	// Function to find majority elements in an array
	private static List<Integer> majorityElementTwoBrute(int[] arr) {
		int n = arr.length;
		List<Integer> result = new ArrayList<>();
